...
///
/// \ingroup base
/// \class ttk::KernelDensityEstimation
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// This module defines the %KernelDensityEstimation class that computes for each vertex of a
...
namespace ttk {
  ...
  /**
   * The KernelDensityEstimation class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */

  class KernelDensityEstimation : virtual public Debug {
