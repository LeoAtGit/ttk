...
# create a new 'TTK PersistencePairsRepresentatives'
tTKPersistencePairsRepresentatives1 = TTKPersistencePairsRepresentatives(PersistenceDiagram=threshold3)
...
# create a new 'TTK BlockAggregator'
tTKBlockAggregator5 = TTKBlockAggregator(Input=tTKPersistencePairsRepresentatives1)
...
# create a new 'TTK Extract'
tTKExtract5 = TTKExtract(Input=tTKEndFor1)
...
tTKTrackingGraph2.Matrix = ['POINTS', 'LiftedWassersteinDistance']
...
liftedWassersteinDistanceLUT.RGBPoints = [0., 0.231373, 0.298039, 0.752941, 0., 0.865003, 0.865003, 0.865003, 0., 0.705882, 0.0156863, 0.14902]
...
liftedWassersteinDistancePWF.Points = [0.0, 0.0, 0.5, 0.0, 0.0, 1.0, 0.5, 0.0]
