...
/// \date The Date Here.
///
/// This module defines the %BranchDecomposition class that computes for each vertex of a
...
namespace ttk {
  ...
  /**
   * The BranchDecomposition class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */
