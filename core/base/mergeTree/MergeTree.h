        ...
        public:
            ...
            int initializePropagations(
                ...
                this->printMsg(
                    ...
                    0.5,timer.getElapsedTime(),this->threadNumber_,debug::LineMode::REPLACE
                );
            ...
            int finalizePropagations(
                ...
                this->printMsg(
                    "Finalizing Propagations ("+std::to_string(nPropagations)+"|"+std::to_string(nVertices)+")",
                    1,timer.getElapsedTime(),this->threadNumber_
                );
                ...
                for(; trunkIndex>=0; trunkIndex--){
                    ...
                    for(IT n=0; n<nNeighbors; n++){
                        ...
                        if(propagationMask[u]!=nullptr){
                            ...
                            if(!currentPropagation || orderArray[currentPropagation->criticalPoints[0]] < orderArray[temp->criticalPoints[0]]){
            ...
            int computeMergeTreeSegmentation(
                ...
                const TT* triangulation,
                const IT* orderArray,
                const int& type = 0 // 0: split tree, 1: join tree
            ) const {
                ttk::Timer timer;
