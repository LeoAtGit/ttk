...
/// component, where the label -1 can be used to mask the background. The
/// computed components store the size and center of mass of each vertex group.
/// The module also assigns a unqiue positive integer to each component and maps
