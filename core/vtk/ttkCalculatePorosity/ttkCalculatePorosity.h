...
///
/// \ingroup vtk
/// \class ttkCalculatePorosity
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the ttk::CalculatePorosity module.
///
/// This VTK filter uses the ttk::CalculatePorosity module to compute an averaging of
...
///   - standalone/CalculatePorosity/main.cpp
///
/// See the related ParaView example state files for usage examples within a
/// VTK pipeline.
///
/// \sa ttk::CalculatePorosity
/// \sa ttkAlgorithm

#pragma once

// VTK Module
#include <ttkCalculatePorosityModule.h>
...
// TTK Base Includes
#include <CalculatePorosity.h>

class TTKCALCULATEPOROSITY_EXPORT ttkCalculatePorosity
  : public ttkAlgorithm // we inherit from the generic ttkAlgorithm class
  ,
    protected ttk::CalculatePorosity // and we inherit from the base class
{
private:
  /**
 ...
 public:
   ...
   */
  static ttkCalculatePorosity *New();
  vtkTypeMacro(ttkCalculatePorosity, ttkAlgorithm);
