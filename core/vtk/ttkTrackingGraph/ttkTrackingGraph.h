...
///
/// This VTK filter uses the ttk::TrackingGraph module to compute an averaging of
...
class TTKTRACKINGGRAPH_EXPORT ttkTrackingGraph
  : public ttkAlgorithm, protected ttk::TrackingGraph
{
private:
